...
export function EditPaymentLinkPage({ linkId }: EditPaymentLinkPageProps) {
  ...
  const handleUpdatePaymentLink = async (data: {
    title: string;
    slug: string;
    price: number;
    type: "one_time" | "subscription";
    ...
    alert(`Payment link &quot;${data.title}&quot; updated successfully!`);
  ...
  return (
    <div className="container max-w-5xl mx-auto p-6 space-y-6">
      ...
      {/* Page Title */}
      <div>
        <h1 className="text-3xl font-bold">Edit Payment Link</h1>
        <p className="text-muted-foreground mt-2">
          Update &quot;{paymentLink.title}&quot; settings and content
        </p>
      </div>

      {/* Edit Form */}
      <CreatePaymentLinkForm
        onSubmit={handleUpdatePaymentLink}
